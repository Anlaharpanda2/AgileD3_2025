<template>
  <div class="overlay" @click.self="$emit('close')">
    <div class="popup">
      ...
      <h2 class="title">Export Data Konsultasi</h2>
...
// Kolom disesuaikan dengan model DataKonsultasi yang diberikan
const exportColumns = [
  ...
  { key: "umur", label: "Umur" },
  { key: "deskripsi_data_konsultasi", label: "Deskripsi Konsultasi" },
