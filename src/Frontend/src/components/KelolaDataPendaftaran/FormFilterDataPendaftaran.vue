...
const getColumnIcon = (column: string) => {
  ...
  if (col.includes('gender') || col.includes('jenis_kelamin')) return IconUsers; // Menggunakan IconUsers untuk gender
  if (col.includes('birth') || col.includes('lahir') || col.includes('tanggal_lahir')) return IconCalendar; // Menggunakan IconCalendar untuk tanggal lahir
  ...
  // Lokasi
  if (col.includes('location') || col.includes('lokasi')) return IconMapPin; // Menggunakan MapPin karena Navigation lebih umum
  ...
  if (col.includes('nik') || col.includes('ktp')) return IconIdCard;
  if (col.includes('number') || col.includes('nomor')) return IconHash; // Menggunakan IconHash untuk nomor generik
