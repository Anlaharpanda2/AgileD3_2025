            ...
            <div class="bg-gray-50 rounded-xl p-5 sm:p-6 border border-gray-100 shadow-sm">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                >
                  ...
                  >
                  <div
                    v-if="form.lampiran_preview_url"
                    class="mt-2"
                  >
                    ...
                    <img
                      :src="form.lampiran_preview_url"
                      alt="Pratinjau Lampiran"
                      class="w-24 h-24 object-cover rounded-lg"
                    >
                  </div>
                  <div
                    v-if="form.current_lampiran_url"
                    class="mt-2"
                  >
                    <p class="text-sm text-gray-500">
                      Lampiran saat ini:
...
const submitForm = () => {
  formRef.value.validate(async (valid: boolean) => {
    ...
    try {
      const response = await api.post(`/kelola/pengaduan/${form.id}`, formData, {
        headers: {
