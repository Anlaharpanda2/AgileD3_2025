...
const exportColumns = [
  { key: "kode_pengaduan", label: "Kode Pengaduan" },
  { key: "nama_pelapor", label: "Nama Pelapor" },
  { key: "nama_korban", label: "Nama Korban" },
  ...
  { key: "lampiran_url", label: "Lampiran URL" },
]
  ...
  >
    ...
    <div class="relative bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl shadow-gray-500/10 p-8 w-full max-w-md mx-auto animate-scale-in max-h-[90vh] overflow-y-auto md:max-h-auto">
      ...
      <div class="text-center mb-8">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mb-2">Export Data Pengaduan</h2>
        ...
        <div class="mt-6 p-4 bg-gradient-to-r from-pink-50 to-pink-100 rounded-xl border border-pink-200">
          <div class="flex items-center">
            ...
            <div class="flex-1">
              ...
              <p class="text-xs text-pink-500">Data pengaduan akan diekspor sesuai format yang dipilih</p>
            </div>
          </div>
        </div>
