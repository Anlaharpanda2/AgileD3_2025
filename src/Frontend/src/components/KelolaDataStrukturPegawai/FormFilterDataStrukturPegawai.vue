        ...
        <div class="relative bg-gradient-to-r from-pink-50 to-rose-50 border-b border-gray-100">
          <div class="flex items-center justify-between p-6">
            <div class="flex items-center space-x-3">
              ...
              <div>
                <h2 class="text-xl font-bold text-gray-800">Filter Data StrukturPegawai</h2>
...
const getColumnIcon = (column: string): string => {
  ...
  // StrukturPegawai & Pendidikan
  if (col.includes('training') || col.includes('struktur_pegawai')) return 'fas fa-graduation-cap';
