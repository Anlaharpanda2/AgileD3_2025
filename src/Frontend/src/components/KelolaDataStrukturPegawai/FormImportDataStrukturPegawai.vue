        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-3">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500 mt-1">Upload file Excel untuk mengimpor data struktur pegawai</p>
            </div>
          </div>
...
const submitFile = async () => {
  ...
  try {
    await api.post('/kelola/struktur-pegawai/impor', formData) // Updated API endpoint
