    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-4 flex justify-between items-center">
          <div>
            <label for="itemsPerPagePost" class="text-sm text-gray-600">Items per page:</label>
            <select v-model="itemsPerPage" id="itemsPerPagePost" class="ml-2 border-gray-300 rounded-md text-sm">
              <option :value="10">10</option>
              <option :value="20">20</option>
              <option :value="50">50</option>
              <option :value="posttests.length">All</option>
            </select>
          </div>
          <div class="flex items-center">
