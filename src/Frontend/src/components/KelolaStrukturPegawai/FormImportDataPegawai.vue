    ...
    <div class="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl shadow-pink-500/10 animate-in zoom-in-95 duration-300 ease-out">
          ...
          <div class="flex items-center space-x-3">
            ...
            <div>
              <h3 class="text-2xl font-bold text-gray-900">
                Impor Data Struktur Pegawai
              </h3>
              <p class="text-sm text-gray-500 mt-1">
                Upload file Excel untuk mengimpor data struktur pegawai
              </p>
            </div>
          </div>
      ...
      <div class="px-8 pb-8 pt-4">
        ...
        <div class="flex items-center justify-between mt-8 pt-6 border-t border-gray-100">
          ...
          <div class="flex items-center space-x-3">
            <a
              href="/import/format-struktur-pegawai.xlsx"
              download
...
const submitFile = async () => {
  ...
  try {
    await api.post('/kelola/struktur-pegawai/impor', formData)
