  ...
  <transition name="fade">
    <div v-if="visible" class="form-overlay-wrapper">
      ...
      <div class="sorting-form-container">
        ...
        <h2 class="form-title">Pengurutan Data Struktur Pegawai</h2>
        <el-form :model="form" label-position="top" class="space-y-6 text-base">
        ...
        <div class="form-actions">
          <el-button @click="cancelSort" class="custom-cancel-button">
            Batal
          </el-button>
          <el-button type="primary" @click="applySort" class="custom-apply-button">
            Terapkan
          </el-button>
        </div>
      </div>
