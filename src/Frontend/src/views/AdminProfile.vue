    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div v-else-if="error" class="p-8 text-center">
          ...
          <h3 class="mt-4 text-xl font-semibold text-gray-800">Gagal Memuat Data</h3>
          <p class="mt-2 text-gray-500">{{ error }}</p>
        </div>

        <!-- Profile Content -->
        <div v-else-if="user" class="transition-opacity duration-500">
          <!-- Profile Header -->
          ...
          <!-- Profile Details -->
          <div class="p-8">
            <h3 class="text-lg font-semibold text-gray-700 mb-6 border-b pb-3">Detail Informasi</h3>
            <ul class="space-y-5">
              <li class="flex items-center">
                <div class="w-10 h-10 flex-shrink-0 bg-gray-100 rounded-lg flex items-center justify-center mr-4">
                  <svg class="w-6 h-6 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.206" /></svg>
                </div>
                <div>
              ...
              <li class="flex items-center">
                <div class="w-10 h-10 flex-shrink-0 bg-gray-100 rounded-lg flex items-center justify-center mr-4">
                   <svg class="w-6 h-6 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                </div>
                <div>
               ...
               <li class="flex items-center">
                ...
                <div>
                  ...
                  <p class="font-medium text-gray-800">{{ formattedJoinDate }}</p>
                </div>
              </li>
            </ul>
          </div>
