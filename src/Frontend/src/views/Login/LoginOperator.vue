      ...
      >
        ...
        >
          <div class="w-full max-w-[280px] lg:max-w-[250px]">
            <h2 class="text-center text-black text-2xl lg:text-xl font-bold font-['Poppins'] mb-2">MASUK OPERATOR</h2>
            ...
            <form @submit.prevent="handleLogin" class="space-y-4 lg:space-y-3">
              ...
              <div class="flex items-center pt-2 lg:pt-1">
                ...
                >
                <label for="show-password" class="ml-2 text-sm lg:text-[8px] font-['Poppins'] text-gray-700">Tampilkan Password</label>
              </div>
            ...
            <p class="text-center text-sm lg:text-[9px] mt-6 lg:mt-4 font-['Roboto']">
              ...
              <a href="/reset/forgot" class="font-bold text-[#fe3275] hover:underline">Reset</a>
            </p>
            ...
            <div class="space-y-3 lg:space-y-2">
              <a href="/login/masyarakat" class="flex items-center justify-center w-full h-[45px] lg:h-[35px] border border-gray-300 rounded-[10.67px] hover:bg-gray-100 hover:border-pink-400 transition group">
                <img src="https://c.animaapp.com/IJi6pJQY/img/manage-accounts-24dp-e8eaed-fill0-wght400-grad0-opsz24-1.svg" class="w-6 h-6 lg:w-5 lg:h-5 mr-4" alt="Masyarakat icon">
