  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    ...
    >
      <div class="text-center">
        <div class="inline-block animate-spin rounded-full h-12 w-12 border-4 border-pink-500 border-t-transparent" />
        ...
        <div class="lg:col-span-2">
          <article class="bg-white rounded-3xl shadow-xl overflow-hidden">
            ...
            <div class="relative">
              ...
              <!-- Featured Image -->
              <div
                v-if="pengumuman.foto"
                class="relative h-80 bg-gradient-to-br from-gray-200 to-gray-300"
              >
                <img 
                  :src="pengumuman.foto" 
              ...
              <div
                v-else
                class="h-32 bg-gradient-to-br from-pink-100 to-purple-100 flex items-center justify-center"
              >
                <div class="text-center">
                  <svg
                    class="w-8 h-8 text-pink-400 mx-auto mb-2"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <p class="text-pink-600 font-medium text-sm">
                    Pengumuman Resmi
                  </p>
                </div>
              </div>
            ...
            <div class="p-8 lg:p-12">
              ...
              <header class="mb-8">
                ...
                <div class="flex flex-wrap items-center gap-6 text-sm text-gray-500">
                  ...
                  <div
                    v-if="pengumuman.updated_at !== pengumuman.created_at"
              ...
              <div class="prose prose-lg prose-gray max-w-none">
                <div class="bg-gray-50 rounded-2xl p-8 border-l-4 border-pink-500">
                  <p class="text-gray-800 leading-relaxed whitespace-pre-wrap text-lg">
                    {{ pengumuman.isi }}
                  </p>
                </div>
              </div>
        ...
        <div class="lg:col-span-1">
          <div class="sticky top-8">
            <div class="bg-white rounded-2xl shadow-lg p-6">
              ...
              <!-- List Rekomendasi -->
              <div
                v-else-if="rekomendasiPengumuman.length > 0"
                class="space-y-4"
              >
                <article 
