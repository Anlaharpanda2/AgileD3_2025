  ...
  <div class="mb-4">
    ...
    >
      ...
      <div class="mb-6 sm:mb-8">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Data Panitia Sampah</h1>
        <p class="text-gray-600 text-sm sm:text-base">Kelola dan pantau semua data panitia yang telah dihapus</p>
      </div>
...
const visibleColumns = computed(() => {
  ...
  return allColumns.value.filter(col => ['nama_panitia', 'email', 'jabatan', 'no_hp'].includes(col.key));
});
