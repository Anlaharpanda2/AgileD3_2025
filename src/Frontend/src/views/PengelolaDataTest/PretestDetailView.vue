        ...
        <div v-if="pretest.id">
          ...
          <div v-if="pretest.questions && pretest.questions.length > 0">
            <div
              ...
              class="border border-gray-200 p-6 mb-4 rounded-lg shadow-sm bg-gray-50 transition-all duration-300 ease-in-out hover:shadow-md"
            >
          ...
          <div
            v-else
            class="text-gray-500 p-4 border border-dashed border-gray-300 rounded-md text-center"
          >
          ...
          <div class="mt-8 flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-4">
            <el-button
              type="primary"
              class="w-full md:w-auto bg-pink-500 text-white hover:bg-pink-600 border-none rounded-md transition-all duration-300 ease-in-out"
              @click="startPretest"
            >
              Kerjakan Pretest
            </el-button>
