  ...
  <layout>
    ...
    <div v-if="loading" class="min-h-screen bg-gray-50 flex items-center justify-center">
      <div class="text-center">
        ...
        <p class="text-gray-600 font-medium">Memuat detail pengaduan...</p>
      </div>
    </div>
    ...
    <div v-else-if="error" class="min-h-screen bg-gray-50 flex items-center justify-center">
      <div class="max-w-md w-full mx-4">
        <div class="bg-white rounded-2xl shadow-lg border border-red-100 p-8 text-center">
          ...
          <button @click="fetchDetail" class="w-full bg-pink-500 hover:bg-pink-600 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 transform hover:scale-105">
    ...
    <!-- Main Content -->
    <div v-else-if="pengaduan" class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-pink-500 to-pink-600 px-6 py-4">
              <div class="flex items-center justify-between">
                <button @click="goBack" class="flex items-center text-white hover:text-pink-100 transition-colors group">
                ...
                <div class="flex items-center space-x-3">
                  <div :class="statusBadgeClass" class="px-4 py-2 rounded-full text-sm font-semibold shadow-sm">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              <div class="bg-gradient-to-r from-pink-50 to-pink-100 px-6 py-4 border-b border-pink-200">
                <div class="flex items-center">
                  ...
                  <div>
                    <h2 class="text-xl font-bold text-gray-900">Informasi Pelapor</h2>
                    <p class="text-sm text-gray-600">Data orang yang melaporkan kejadian</p>
                  </div>
                </div>
              </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div class="group">
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 group-hover:bg-gray-100 transition-colors">
                      <p class="text-gray-900 font-medium text-lg">{{ pengaduan.nama_pelapor }}</p>
                    </div>
                  </div>
                  <div class="group">
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Nomor HP</label>
                    <div class="bg-gray-50 rounded-xl p-4 group-hover:bg-gray-100 transition-colors">
                      <p class="text-gray-900 font-medium text-lg">{{ pengaduan.no_hp }}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              <div class="bg-gradient-to-r from-red-50 to-red-100 px-6 py-4 border-b border-red-200">
                <div class="flex items-center">
                  ...
                  <div>
                    <h2 class="text-xl font-bold text-gray-900">Informasi Korban</h2>
                    <p class="text-sm text-gray-600">Data orang yang menjadi korban</p>
                  </div>
                </div>
              </div>
              ...
              <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div class="group">
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 group-hover:bg-gray-100 transition-colors">
                      <p class="text-gray-900 font-medium text-lg">{{ pengaduan.nama_korban }}</p>
                    </div>
                  </div>
                  <div class="group">
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Saksi</label>
                    <div class="bg-gray-50 rounded-xl p-4 group-hover:bg-gray-100 transition-colors">
                      <p class="text-gray-900 font-medium text-lg">{{ pengaduan.saksi || 'Tidak ada saksi' }}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              <div class="bg-gradient-to-r from-blue-50 to-blue-100 px-6 py-4 border-b border-blue-200">
                <div class="flex items-center">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600">Informasi lengkap tentang kejadian</p>
                  </div>
                </div>
              </div>
              ...
              <div class="p-6 space-y-6">
                <div class="group">
                  ...
                  <div class="bg-gray-50 rounded-xl p-4 group-hover:bg-gray-100 transition-colors">
                    <p class="text-gray-900 font-medium text-lg">{{ formatDateTime(pengaduan.waktu_kejadian) }}</p>
                  </div>
                </div>
                ...
                <div class="group">
                  ...
                  <div class="bg-gray-50 rounded-xl p-4 group-hover:bg-gray-100 transition-colors">
                    <p class="text-gray-900 font-medium text-lg whitespace-pre-line">{{ pengaduan.alamat }}</p>
                  </div>
                </div>
                ...
                <div class="group">
                  ...
                  <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6 group-hover:from-gray-100 group-hover:to-gray-200 transition-colors">
                    <p class="text-gray-900 leading-relaxed text-lg">{{ pengaduan.deskripsi }}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="xl:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-bold text-gray-900">Status Pengaduan</h3>
              </div>
              
              <div class="p-6 text-center">
                <div :class="statusIconBgClass" class="w-20 h-20 mx-auto rounded-2xl flex items-center justify-center mb-4">
                  <svg :class="statusIconTextClass" class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path v-if="pengaduan.status === 'selesai'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    <path v-else-if="pengaduan.status === 'diproses'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    <path v-else stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z"></path>
                  </svg>
                </div>
                
                <div :class="statusBadgeClass" class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold mb-3">
            ...
            <!-- Lampiran -->
            <div v-if="pengaduan.lampiran" class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              <div class="bg-gradient-to-r from-purple-50 to-purple-100 px-6 py-4 border-b border-purple-200">
                <h3 class="text-lg font-bold text-gray-900">Lampiran</h3>
              </div>
              ...
              <div class="p-6">
                <div class="border-2 border-dashed border-gray-200 rounded-xl p-6 hover:border-pink-300 hover:bg-pink-50 transition-all duration-200 group">
                  <div class="text-center">
                    ...
                    <h4 class="font-semibold text-gray-900 mb-2">{{ getFileName(pengaduan.lampiran) }}</h4>
                    <p class="text-sm text-gray-600 mb-4">Dokumen lampiran pengaduan</p>
                  </div>
                  
                  <div class="grid grid-cols-2 gap-3">
                    <button @click="viewAttachment" class="bg-pink-500 hover:bg-pink-600 text-white font-semibold py-2 px-4 rounded-xl transition-all duration-200 transform hover:scale-105">
                    ...
                    <button @click="downloadAttachment" class="bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-2 px-4 rounded-xl transition-all duration-200">
                      <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-bold text-gray-900">Aksi Pengaduan</h3>
              </div>
              
              <div class="p-6 space-y-4">
                <button @click="editPengaduan" class="w-full bg-pink-500 hover:bg-pink-600 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 transform hover:scale-105 flex items-center justify-center">
    ...
    <div v-else class="min-h-screen bg-gray-50 flex items-center justify-center">
      <div class="text-center">
        ...
        <p class="text-gray-600 mb-4">Pengaduan yang Anda cari tidak dapat ditemukan.</p>
        <button @click="goBack" class="bg-pink-500 hover:bg-pink-600 text-white font-semibold py-2 px-6 rounded-xl transition-colors">
          Kembali
        </button>
      </div>
    </div>
