      ...
      >
        ...
        >
          <div class="w-full max-w-[280px] lg:max-w-[250px]">
            <h2 class="text-center text-black text-2xl lg:text-xl font-bold font-['Poppins'] mb-2">LUPA KATA SANDI</h2>
            <p class="text-center text-gray-600 text-sm lg:text-[10.7px] mb-6 lg:mb-4 font-['Poppins']">
              Masukkan email Anda untuk menerima OTP
            </p>

            <form @submit.prevent="handleSubmit" class="space-y-4 lg:space-y-3">
              <div class="relative w-full h-[45px] lg:h-[35px]">
                <div class="absolute left-3 top-1/2 -translate-y-1/2">
                  <img class="w-5 h-5 lg:w-4 lg:h-4" src="https://c.animaapp.com/IJi6pJQY/img/frame-1.svg" alt="Email icon">
                </div>
                <input
                  v-model="email"
                  type="email"
            ...
            <p class="text-center text-sm lg:text-[9px] mt-6 lg:mt-4 font-['Roboto']">
              ...
              <a href="/login/operator" class="font-bold text-[#fe3275] hover:underline">Login</a>
            </p>
          </div>
        </div>
      </div>
