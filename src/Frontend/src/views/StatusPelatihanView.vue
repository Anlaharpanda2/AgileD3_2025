      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div
            ...
            class="transition-opacity duration-500 cursor-pointer hover:shadow-2xl"
            @click="goToProfileDetail"
          >
            <!-- Profile Header -->
                ...
                <li class="flex items-center">
                  ...
                  <div>
                    ...
                    <p
                      ...
                      :class="statusClass(profileData.status_pendaftaran)"
                    >
                      {{ profileData.status_pendaftaran }}
                    </p>
                  </div>
                </li>
                <li class="flex items-center">
